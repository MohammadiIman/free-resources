...
4 . [کتاب آموزش آزاد پایتون](https://pythonpersian.com/) : این کتاب تلاشی است برای آموزش زبان برنامه‌نویسی پایتون (Python) بر پایه‌ پیاده‌سازی استاندارد آن (CPython)، به زبانی ساده و روان که بتواند برای افرادی که تاکنون پیشینه برنامه‌نویسی نداشته‌اند نیز کاربردی و مفید باشد. مطالعه این کتاب نیازی به پیش‌زمینه برنامه‌نویسی ندارد و تنها پیش‌نیاز آن علاقه خوانندگان به فن برنامه‌نویسی است.
...
7 . [ساختار داده در پایتون](https://github.com/alireza-fa/data-structures-python) : معرفی ساختمان داده و انوع آن بصورت اجمالی و پیاده سازی ساختمان داده های مختلف در پایتون
...
1 . [کتاب فارسی آموزش گیت](https://git-scm.com/book/fa/v2) : آموزش گیت به زبان فارسی
...
10 . [دورهٔ AsyncIO به فارسی](https://github.com/irvaniamirali/asyncio-course-fa) : دورهٔ متنی و عملی برنامه‌نویسی غیرهمزمان در پایتون که async و await، حلقهٔ رویداد، مدیریت تسک‌ها، تست کدهای async، صف‌ها، همگام‌سازی، شبکه و الگوهای هم‌زمانی را در ۲۱ درس پوشش می‌دهد.
